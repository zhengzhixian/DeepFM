...
class FeatureDictionary(object):
    ...
    #若为连续变量 feat_dict value为当前列序号tc
    #若为类别变量 feat_dict value为 类别与递增序号的字典 用以产生onehot
    #ex: col1:cate1,cate2,cate3 则feat_dict[col] = {cate1:tc,cate2:tc+1,cate3:tc+3}
    #feat_dict 用以产生特征下标Xi
